...
\begin{abstract}
  ...
  energy for the remaining evolution. Comparing accretor models from
  ...
  eject a CE ejection for both black hole and neutron star progenitors
  by $\sim 4-58\%$, depending on the evolutionary stage and final
  orbital separation. Therefore, GW progenitors experiencing stable
  mass transfer may more easily survive subsequent possible CE events
...
We have focused on the consequences of accretion in the first RLOF for
subsequent binary interaction on the path to a GW merger: the CE event
initiated by the RLOF-accretor. We find that accretors have overall
lower envelopes binding energy (both integrated from the surface to
the He core, see~\Figref{fig:BE_env_R} and as a function of radius,
see~\Figref{fig:BE_profiles}-\ref{fig:grid_ratios}). Since the
...
For very massive BH progenitors with $M\gtrsim 40\,M_\odot$, the
...
generally easier to mix \citep[e.g.,][]{yoon:2005}, therefore more
studies are needed to asses the importance of their structural
readjustment to RLOF-accretion for subsequent binary interactions.
