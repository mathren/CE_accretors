...
\author[0000-0002-6718-9472]{M.~Renzo \todo{order TBD}}
...
\begin{abstract}
  ...
  the convective core of the accretor star grows and is ``rejuvenated''. This
  leads to a steeper core-envelope boundary region which decreases
...
rejuvenation of the accretors CEB \todo{possibly see appendix here}.
...
POSYDON \cite{fragos:22} and publicly available at \todo{fix}.
...
the CEB specific entropy (s) which controls the thermal properties of
the gas, and its H, and He profiles -- but do not change
...
\Figref{fig:TAMS_profiles}) \todo{explain why accretors may look like this}. We let \mesa\ ``relax'' the TAMS profiles
