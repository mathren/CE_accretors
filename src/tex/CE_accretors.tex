...
gradient at the new (post-accretion) outer edge. \todo{see Stephen
  comment} In practice, binary
...
of the RLOF-accretor triggers a CE. CE evolution is a complicated
physics problem, not necessarily well-described as an energetically
closed system \citep[e.g.,][]{ivanova:2013, ivanova:2020,
  renzo:21gwce}
...
ease of CE ejection. Even if imperfect, we expect that, for the
comparisons in this work, the binding energy is a good enough proxy for
whatever quantities do determine the outcome of CE. We calculate the
