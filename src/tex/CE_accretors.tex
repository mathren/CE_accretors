...
%% while waiting to upload the figures on zenodo
%% TODO: change static/ to figures/ and git rm --cached static/*.pdf
\graphicspath{{../static/}}
...
%% TO TRY ZENODO UPLOAD
\begin{figure}[ht!]
  \script{zenodo_uploader.py}
  \includegraphics[width=0.4\textwidth]{../tex/figures/try.pdf}
