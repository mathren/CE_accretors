...
\citep[e.g.,][]{tutukov:93,belczynski:2016, tauris:2017}, a gravitational-wave
progenitor system experiences a first dynamically stable mass transfer
...
\begin{figure*}[htbp]
  ...
  \caption{Specific entropy (top row), H (bottom row, solid lines),
    ...
    same total mass as the post-RLOF mass of the accretors. The gray
    bands emphasize the CEB region, which is well
    defined at TAMS.\todo{check placement}}
