...
root_TAMS = (
    root / "engineered_stars/TAMS_models/"
)
...
grid_folders15 = sorted(glob.glob(root_eng + "/grid15/*.*/LOGS/"))
grid_folders17 = sorted(glob.glob(root_eng + "/grid17/*.*/LOGS/"))
grid_folders30 = sorted(glob.glob(root_eng + "/grid30/*.*/LOGS/"))
#
...
init_model1 = init_model15
accretor1 = accretor18
nonrot1 = nonrot15

grid_folders2 = grid_folders17
init_model2 = init_model17
accretor2 = accretor20
nonrot2 = nonrot17

grid_folders3 = grid_folders30
init_model3 = init_model30
accretor3 = accretor30
nonrot3 = nonrot30
